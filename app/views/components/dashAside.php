...
<ul class="menu-inner ">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-author"></i>
      <div data-i18n="الكاتب">الكاتب</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="الناشر">الناشر</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="عنوان المستخدم">عنوان المستخدم</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="طرق دفع المستخدم">طرق دفع المستخدم</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="تحقق المستخدم">تحقق المستخدم</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="/add_user_token" class="menu-link">
          <div data-i18n="أضافة تحقق">أضافة تحقق</div>
        </a>
      </li>
    
      <li class="menu-item">
        <a href="/app-user_token-list" class="menu-link">
          <div data-i18n="عرض تحقق المستخدم">عرض تحقق المستخدم</div>
        </a>
      </li>
    </ul>
  </li>
